...
if(isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
    ...
    $row	=	$db->getWhere('p_detail',$_REQUEST['editId']);
}
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                       ...
                                       <div class="col-md-6 col-12">
                                        <?php $d->textinput('text','p_name','Product Name','Insert Name',true,'',$row); ?>
                                        </div>

                                        <div class="col-md-6 col-12">
                                        <?php $d->textinput('number','p_price','Product Price','Insert price',true,'','',$row); ?>
                                        </div>
                                        ...
                                        <?php $d->inputsubmit_update("p_detail",$editId);?>
